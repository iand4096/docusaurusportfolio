...
import navigation from '@site/src/generated/taxonomy-navigation.json';
...
const navigationDocuments = navigation.documents as NavigationDocument[];

function getDocumentDescription(
  doc: Props['tag']['items'][number],
): string | undefined {
  const navigationDocument = navigationDocuments.find(
    (candidate) =>
      candidate.id === doc.id ||
      doc.permalink.endsWith(candidate.path),
  );

  return navigationDocument?.description ?? doc.description;
}
