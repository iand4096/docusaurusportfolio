...
I also created reusable components for skills, tools, and marketing-style content.
...
A portfolio that demonstrates a modern docs-as-code workflow, reusable documentation components, automated deploymen and quality checks.
