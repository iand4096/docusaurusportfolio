...
sidebar_custom_props:
  skillCard:
    ...
    highlights:
      ...
      - Cloud-hosted webhook and encryption validation
      - Test-driven validation of developer documentation
    ariaLabel: Explore my software testing and QA skills
---

Strong practical experience in **software testing, technical validation, and integration testing**, developed early in my career as a software engineer and subsequently alongside technical-writing responsibilities across financial services, payments, mobile, and API platforms. Experienced in using testing not only to verify software behaviour, but also to validate documentation, uncover integration issues, identify security concerns, and improve product readiness.
...
* Experienced identifying, reproducing, documenting, and tracking defects, with clear reproduction steps, expected versus actual behaviour, environmental details, supporting evidence and severity.
