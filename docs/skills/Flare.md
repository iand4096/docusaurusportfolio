...
* Conditional single-sourcing
* Multi-product and multi-platform documentation
* CSS and XML customisation
...
These projects demonstrate advanced experience using Flare as part of an automated documentation platform rather than solely as an authoring tool.
